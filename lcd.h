...
#define LCD_delay           15     // ~5mS
#define LCD_Startup         30     // ~15mS
...
#define LCD_PWR      PORTBbits.RB14                     // LCD power pin
#define LCD_EN       PORTBbits.RB13                     // LCD enable
#define LCD_RW       PORTBbits.RB11                     // LCD read/write line
#define LCD_RS       PORTBbits.RB10                     // LCD register select line
...
#define NB_COL      16                                  // Number of characters per line
    ...
    /**
      @Summary
        Position the cursor at specified line and column
      ...
      @Param
        Column and line at which the cursor should be positioned
